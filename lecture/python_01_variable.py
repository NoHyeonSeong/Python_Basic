...
#     예를 들어서 int는(-100000~10000)까지 담을 수 있다고 가정
#     그런데 우리 회사에서 특정 값이 0~9만 사용!
#     int를 사용하게 되면 메모리 낭비, 이런 경우 크기의 범위가 더
#     작은 자료형을 사용하면 좋음(short)

# 공부(tip)
# - 몇 버전부터 ~ 나온 기술(신기술) -> 신기술 공부, 구기술 공부 X 둘 다 공부

# Python 동적 타이밍 언어 -> Python 실행될 때 Type을 지정!
...
# name 변수 생성
# "Hyeon Seong" 값을 nmae 변수에 담기

# name(변수명), = (대입연산자), "Hyeon Seong"(값)
name = "Hyeon Seong"
...
# 개발자: Web(프론트엔드, 백엔드), 앱(Android, Apple), 앱 퍼블리셔
# 웹 디자이너
...
# 동적 출력!
print("=" * 200)
student_num = 20231234
student_name = "Hyeon Seong"

# 출력 예) "조선대학교 20231234, Hyeon Seong 입니다."
print( "조선대학교 20231234, Hyeon Seong 입니다.") # 하드코딩 지양!
