...
# - 작성일자: 2023년 11월 08일
# - 작성자: Hyeon02
# 내용: 사용자가 수집하고 싶은 뉴스 카테고리를 설정하던 해당 카테고리의 뉴스 기사와 제목을 수집하는 프로그램
# - 라이브러리: results, beautifulsoup4, pymongo
...
while True:
    url = f"https://news.daum.net/breakingnews/{dict_news}?page={page}"
    ...
    if result.status_code == 200:
        ...
        #print(f"기사{page} 페이지의 기사 갯수: {len(url_list)}")
        if len(url_list) == 0:
            break
        ...
        print("URL 경로가 잘못됐습니다. 확인 부탁드립니다.")
    page += 1
